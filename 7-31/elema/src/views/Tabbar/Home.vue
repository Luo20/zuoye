<template>
  <div>
    <div class="box">
      ...
      <span>天河慧通产业广场B区</span>
    </div>
    <!-- 搜索框 -->
    <van-search placeholder="搜索饿了么商家、商品名称" v-model="value" background="#00aaff" />
    <!-- 宫格 -->
    <van-grid>
      <van-grid-item
...
export default {
  ...
  async created() {
    ...
    let kingkongList = await this.$axios(
      "https://www.easy-mock.com/mock/5d4015c04d43913fb8a20f87/list/kingkong"
    );
    this.kingkongList = kingkongList.data.data.kingkongList;
    //获取下拉菜单的数据
    let menu = await this.$axios(
      "https://www.easy-mock.com/mock/5d4015c04d43913fb8a20f87/list/filterconditions"
    );
...
.index-3Nk1e_0 {
  ...
  height: 0.666667rem;
  height: 6.666667vw;
  background: url(//fuss10.elemecdn.com/c/87/bbc659df168e01b35c48809055dfdsvg.svg)
    50% no-repeat;
...
.index-2cE4o_0 {
  ...
  height: 9.226667rem;
  height: 92.266667vw;
  background: url("https://fuss10.elemecdn.com/e/67/a508a86a170bc6cb438aa9bcfc186png.png")
    no-repeat;
  background-size: contain;
  position: relative;
}
...
.index-2cE4o_0 p:last-child {
  ...
  height: 1.226667rem;
  height: 12.266667vw;
  background: url("https://fuss10.elemecdn.com/9/4e/5bc7dbfa8b3c15c0a7a2d0b8ff0cfpng.png")
    no-repeat;
  background-size: cover;
  position: absolute;
  top: 6.666667rem;
